...
<div class="nk-block nk-block-lg">
    ...
    {{-- TITLE --}}
    <x-datatable-head title="Payments" description="You have {{ count($subscriptions) }} payments"/>
    
    {{-- ALERTS --}}
    @include('admin.includes.alerts')

    {{-- CREATE BUTTON --}}
    <a href="{{ route('subscriptions.create') }}"  class="btn btn-primary d-none d-md-inline-flex mb-2">Create</a>
            ...
            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                ...
                <tbody>
                    ...
                    <tr class="nk-tb-item">
                        ...
                        <td class="nk-tb-col">
                            {{ $payment->debit ? $payment->debit->formatted_id : '' }}
                        </td>
                        <td class="nk-tb-col">
                            {{ $payment->amount  }}
                        </td>
                        ...
                        <x-datatable-action :items="[
                            array('name' => 'Edit', 'url' => route('subscriptions.edit', $payment), 'icon'=> 'icon ni ni-pen'),
                            array('name' => 'Delete', 
                                  'onclick' => 'deleteRecord(' . '`' . route('subscriptions.destroy', ['subscription' => $payment]) . '`' .')', 
